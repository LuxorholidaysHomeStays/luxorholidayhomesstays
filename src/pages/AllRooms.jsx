        ...
        <div className="text-center p-8 rounded-xl bg-white shadow-xl max-w-md">
          ...
          <div className="flex gap-4 justify-center">
            <button
              ...
              className="bg-[#D4AF37] text-black px-5 py-3 rounded-lg hover:bg-[#E5C048] transition-colors font-medium"
            >
              Retry
            </button>
            <button
                ...
                >
                  ...
                  >
                    <div className="space-y-2 sm:space-y-3">
                      <label
                        className="flex items-center group cursor-pointer p-1.5 sm:p-3 rounded-lg hover:bg-[#D4AF37]/10
            ...
            {filteredVillas && filteredVillas.length === 0 && (
              <div className="text-center py-12 animate-fadeIn">
                ...
                <button
                  ...
                  className="mt-4 bg-[#D4AF37] text-black px-6 py-2 rounded-lg hover:bg-[#E5C048]
